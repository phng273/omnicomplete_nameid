...
exports.HuggingfaceTokenExtractionProvider = exports.HuggingfaceSentenceSimilarityProvider = exports.HuggingfaceFeatureExtractionProvider = exports.HuggingfaceTextClassificationProvider = exports.HuggingfaceTextGenerationProvider = void 0;
...
class HuggingfaceTokenExtractionProvider {
    constructor(modelName, options = {}) {
        const { id, config } = options;
        this.modelName = modelName;
        this.id = id ? () => id : this.id;
...
exports.HuggingfaceTokenExtractionProvider = HuggingfaceTokenExtractionProvider;
