...
export declare function readPrompts(promptPathOrGlobs: string | string[] | Record<string, string>, basePath?: string): Promise<Prompt[]>;
...
export declare const SUGGEST_PROMPTS_SYSTEM_MESSAGE: {
    role: string;
    content: string;
};
export declare const REFUSAL_PROMPT_SYSTEM_MESSAGE: {
    role: string;
    content: string;
};
export declare const AI_SELF_REFERENCE_PROMPT_SYSTEM_MESSAGE: {
    role: string;
    content: string;
};
