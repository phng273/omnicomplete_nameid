...
exports.CONTEXT_FAITHFULNESS_NLI_STATEMENTS = exports.CONTEXT_FAITHFULNESS_LONGFORM = exports.CONTEXT_RELEVANCE_BAD = exports.CONTEXT_RELEVANCE = exports.CONTEXT_RECALL_ATTRIBUTED_TOKEN = exports.CONTEXT_RECALL = exports.ANSWER_RELEVANCY_GENERATE = void 0;
exports.ANSWER_RELEVANCY_GENERATE = `Generate question for the given answer.
Answer:\nThe PSLV-C56 mission is scheduled to be launched on Sunday, 30 July 2023 at 06:30 IST / 01:00 UTC. It will be launched from the Satish Dhawan Space Centre, Sriharikota, Andhra Pradesh, India
Question: When is the scheduled launch date and time for the PSLV-C56 mission, and where will it be launched from?

Answer:{{answer}}
Question:`;
exports.CONTEXT_RECALL = `Given a context, and an answer, analyze each sentence in the answer and classify if the sentence can be attributed to the given context or not.
...
classification:
`;
exports.CONTEXT_RECALL_ATTRIBUTED_TOKEN = '[Attributed]';
exports.CONTEXT_RELEVANCE = `Please extract relevant sentences from the provided context that is absolutely required answer the following query. If no relevant sentences are found, or if you believe the query cannot be answered from the given context, return the phrase "Insufficient Information".  While extracting candidate sentences you're not allowed to make any changes to sentences from given context.

query: {{query}}
context: {{context}}
candidate sentences:
`;
exports.CONTEXT_RELEVANCE_BAD = 'Insufficient Information';
exports.CONTEXT_FAITHFULNESS_LONGFORM = `Given a question and answer, create one or more statements from each sentence in the given answer.
...
answer: {{answer}}
statements:\n`;
exports.CONTEXT_FAITHFULNESS_NLI_STATEMENTS = `Prompt: Natural language inference
