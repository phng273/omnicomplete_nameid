...
async function readPrompts(promptPathOrGlobs, basePath = '') {
    ...
    if (typeof promptPathOrGlobs === 'string') {
        ...
        promptPathInfos = promptPathOrGlobs.flatMap((pathOrGlob) => {
            (0, tiny_invariant_1.default)(typeof pathOrGlob === 'string', `Prompt path must be a string, but got ${JSON.stringify(pathOrGlob)}`);
            ...
            logger_1.default.debug(`Expanded prompt ${pathOrGlob} to ${resolvedPath} and then to ${JSON.stringify(globbedPaths)}`);
